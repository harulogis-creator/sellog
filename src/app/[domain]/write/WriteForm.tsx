...
export function WriteForm({ blogId, domain, products = [] }: WriteFormProps) {
  ...
  const [metaDescLen, setMetaDescLen] = useState(0);
  ...
  return (
    <form action={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <Input ref={titleRef} id="title" name="title" required placeholder={t("blog.editor.titlePlaceholder")} />
      </div>
      ...
      <div className="space-y-2">
        ...
        <Input ref={slugRef} id="slug" name="slug" required placeholder={t("blog.editor.slugPlaceholder")} />
        <p className="text-xs text-neutral-500">{t("blog.editor.slugHint")}</p>
      </div>
      <div className="space-y-2">
        ...
        <textarea
          ...
          className="w-full min-h-[60px] rounded-2xl border-2 border-neutral-200 bg-neutral-50/80 px-5 py-3 text-sm text-neutral-900 placeholder:text-neutral-400 focus:outline-none focus:border-neutral-400 focus:bg-white transition-all"
          placeholder={t("blog.editor.metaPlaceholderWithAi")}
        />
        <p className="text-xs text-neutral-500">
          ...
          {" · "}{t("blog.editor.metaHintAuto")}
        </p>
      </div>
      <div className="space-y-2">
        <Label htmlFor="thumbnail_url" className="text-neutral-700">{t("blog.editor.thumbnailLabel")}</Label>
        <Input id="thumbnail_url" name="thumbnail_url" type="url" placeholder={t("blog.editor.thumbnailPlaceholder")} />
      </div>
      ...
      <div className="space-y-2">
        ...
        {showPreview ? (
          <div className="min-h-[280px] rounded-3xl border-2 border-neutral-200 bg-neutral-50/80 p-5 text-neutral-700">
          ...
          <textarea
            ...
            className="w-full h-12 min-h-[280px] rounded-3xl border-2 border-neutral-200 bg-neutral-50/80 px-5 py-4 text-[15px] text-neutral-900 placeholder:text-neutral-400 focus:outline-none focus:border-neutral-400 focus:bg-white focus:ring-2 focus:ring-neutral-200 font-mono transition-all"
            placeholder={t("blog.editor.bodyPlaceholderWithInsert")}
          />
        )}
      </div>
